...
export default function AboutPage() {
  return (
    <div className="w-full overflow-x-hidden bg-[#4040c0] font-lexend min-h-[100dvh]">
      ...
      {/* ── MAIN SECTION ─────────────────────────────────────────────────────── */}
      <section className="relative w-full flex flex-col items-center pt-24 pb-16 px-4 sm:px-6">
        ...
        >
          ...
          <div className="bg-[#f2e1b3] rounded-[2rem] sm:rounded-full flex flex-col sm:flex-row items-center overflow-hidden w-full sm:w-[115%] lg:w-[120%] ml-0 sm:ml-[-7.5%] lg:ml-[-10%] border-2 border-[#000650] p-2 sm:p-0">
            ...
            {/* Right: tagline text */}
            <p className="text-[#000650] font-poppins font-bold text-base sm:text-2xl lg:text-[28px] pt-3 sm:pt-0 pl-4 sm:pl-6 pr-4 sm:pr-8 pb-3 sm:pb-0 leading-snug tracking-[1px] sm:tracking-[2px] lg:tracking-[3px] text-center sm:text-left w-full">
        ...
        <motion.img
          ...
          className="absolute top-[4px] -right-[40px] sm:-top-[8px] sm:-right-[45px] lg:-top-[4px] lg:-right-[94px] w-[253px] sm:w-[250px] lg:w-[438px] object-contain z-10 pointer-events-none drop-shadow-xl"
        />
        ...
        <motion.img
          ...
          className="relative sm:absolute mt-8 sm:mt-0 mb-4 sm:mb-0 top-0 sm:top-[50px] lg:-top-[60px] left-0 sm:-left-[125px] lg:-left-[15px] w-[450px] max-w-none sm:max-w-full sm:w-[450px] lg:w-[607px] mx-auto sm:mx-0 object-contain z-10 pointer-events-none drop-shadow-2xl block"
        />
        ...
        <motion.div
          ...
          className="relative w-full max-w-5xl mx-auto z-0 mt-6 sm:mt-8 lg:mt-12 flex flex-col gap-6"
        >
          {/* Upper Card - Dark Blue */}
          <div className="bg-[#030954] rounded-[1.5rem] border-2 border-[#f2e1b3]/40 overflow-hidden relative z-10">
            <div className="flex flex-col px-6 sm:pl-[180px] lg:pl-[180px] pr-6 sm:pr-16 py-8 sm:py-10">
          ...
          {/* Lower Card - Cream */}
          <div className="bg-[#f2e1b3] rounded-[3rem] w-[115%] ml-[-7.5%] sm:w-[120%] sm:ml-[-10%] overflow-hidden px-6 sm:px-12 pt-24 pb-8 sm:pt-32 sm:pb-10 -mt-20 sm:-mt-32 z-0 relative">
        ...
        <motion.div
          ...
          viewport={{ once: true }}
          transition={{ duration: 0.6, delay: 0.1 }}
          className="w-full max-w-5xl mx-auto mt-24 sm:mt-32 lg:mt-40 text-center px-2 relative z-10"
        >
          <h2
